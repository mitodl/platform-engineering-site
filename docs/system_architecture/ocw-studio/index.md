...
This is a C4 view of **OCW Studio** within the MIT Open Learning SOA,
...
1. [System Context](system-context.md) — OCW Studio and the systems it exchanges data with.
2. [Containers](container.md) — the runtime units inside OCW Studio.
