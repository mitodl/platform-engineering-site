...
BLOG_AUTHOR = "MIT Online Learning Platform Engineering"  # (translatable)
BLOG_TITLE = "Platform Engineering Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pe.ol.mit.edu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pe.ol.mit.edu/"
BLOG_EMAIL = "ol-devops@mit.edu"
BLOG_DESCRIPTION = "MIT Online Learning Platform Engineering Website"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/pages/how_to/", "How To"),
        ("/pages/post_mortems/", "Post Mortems"),
    ),
}
