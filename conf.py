...
BLOG_AUTHOR = "MIT Online Learning Platform Engineering Team"  # (translatable)
BLOG_TITLE = "MIT Online Learning Platform Engineering Site"  # (translatable)
...
BLOG_DESCRIPTION = "MIT Online Learning Website for Platform Engineering."  # (translatable)
